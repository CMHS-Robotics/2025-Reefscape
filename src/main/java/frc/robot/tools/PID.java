...
public class PID {
	...
	public String toString(){
		...
		return "Target Position:" + getSetPoint() + "  Set Value: " + getResult() + "  Error: " + (int)(error * 100)/100.0  + "  Threshold: " + thresholdOn + ", errorThreshold:  " + errorThreshold + ", thresholdValue: " + thresholdValue;
	}
}